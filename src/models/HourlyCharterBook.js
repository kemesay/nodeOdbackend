...
const HourlyCharterBook = sequelize.define(
  "HourlyCharterBook",
  {
    ...
    // Admin manual discount only (see applyDiscountToHourlyCharterBook). Kept
 ...
 */
const validateHourlyCharterBookUpdate = Joi.object({
  ...
  selectedHours: Joi.number().integer().min(1).max(24),
  occasion: Joi.string().min(1).max(100),
